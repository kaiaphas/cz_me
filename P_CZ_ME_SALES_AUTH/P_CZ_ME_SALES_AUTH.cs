    ...
    public partial class P_CZ_ME_SALES_AUTH : PageBase
    {
        ...
        private void InitGrid()
        {
           ...
           _flexM.SetCol("예산계정코드", "CD_BGACCT", 0, false);
            ...
            _flexM.SetCol("더존통제구분", "더존통제구분", 120, false);
            _flexM.SetCol("MTS통제구분", "MTS통제구분", 120, true);
            ...
            _flexM.Cols["더존통제구분"].TextAlign = TextAlignEnum.CenterCenter;
            _flexM.Cols["MTS통제구분"].TextAlign = TextAlignEnum.CenterCenter;
        ...
        protected override void InitPaint()
        {
            ...
            //콤보박스 셋팅
            _flexM.SetDataMap("MTS통제구분", MA.GetCode("CZ_ME_C017", true), "CODE", "NAME");
