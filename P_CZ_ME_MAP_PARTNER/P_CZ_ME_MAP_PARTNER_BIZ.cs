            ...
            if (dtM != null)
            {
              ...
              /*
                ...
                */
                ...
                si.SpParamsInsert = new string[] { "CD_COMPANY", "BIZ_ID", "BIZ_NAME", "CD_PARTNER", "LN_PARTNER", "NO_APPLY", "BIZ_NO", "MGR_NAME", "ADRESS", "BIZ_TYPE", "BIZ_TYPE2", "BANK", "ACCOUNT", "ID_INSERT" };
                si.SpParamsUpdate = new string[] { "CD_COMPANY", "BIZ_ID", "BIZ_NAME", "CD_PARTNER", "LN_PARTNER", "NO_APPLY", "BIZ_NO", "MGR_NAME", "ADRESS", "BIZ_TYPE", "BIZ_TYPE2", "BANK", "ACCOUNT", "ID_UPDATE" };
                sic.Add(si);
            }
