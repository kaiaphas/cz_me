...
namespace cz
{
    ...
    public partial class P_CZ_ME_BOND_DOCU : PageBase
    {
        ...
        private void InitGrid()
        {
            ...
            _flexM.SetCol("CORPNO", "종류", 100, false);
            _flexM.SetCol("AM_BUDGET", "설정액", 100, false, typeof(decimal), FormatTpType.FOREIGN_MONEY);

            _flexM.SetCol("AM_PRE", "체결일", 100, false, typeof(decimal), FormatTpType.YEAR_MONTH_DAY);
            _flexM.SetCol("AM_PRE", "시작일", 100, false, typeof(decimal), FormatTpType.YEAR_MONTH_DAY);
            _flexM.SetCol("AM_PRE", "만기일", 100, false, typeof(decimal), FormatTpType.YEAR_MONTH_DAY);
            _flexM.SetCol("AM_PRE", "소멸시효", 100, false, typeof(decimal), FormatTpType.YEAR_MONTH_DAY);

            _flexM.SetCol("CORPNO", "소유자", 100, false);
            _flexM.SetCol("CORPNO", "채무자", 100, false);
            _flexM.SetCol("CORPNO", "물건지", 100, false);
            _flexM.SetCol("CORPNO", "종류", 100, false);
            _flexM.SetCol("CORPNO", "공증번호", 100, false);
            _flexM.SetCol("CORPNO", "발행인1", 100, false);
            _flexM.SetCol("CORPNO", "발행인2", 100, false);
            _flexM.SetCol("CORPNO", "발행인3", 100, false);
            _flexM.SetCol("CORPNO", "증권번호", 100, false);
            _flexM.SetCol("CORPNO", "보험료", 100, false);
            _flexM.SetCol("CORPNO", "연대보증인1", 100, false);
            _flexM.SetCol("CORPNO", "연대보증인2", 100, false);
            _flexM.SetCol("CORPNO", "연대보증인3", 100, false);
            _flexM.SetCol("CORPNO", "제3채1", 100, false);
            _flexM.SetCol("CORPNO", "제3채2", 100, false);
            _flexM.SetCol("CORPNO", "제3채3", 100, false);
            _flexM.SetCol("CORPNO", "구분(문서명)", 100, false);

            _flexM.SetCol("AM_PRE", "시작일", 100, false, typeof(decimal), FormatTpType.YEAR_MONTH_DAY);
            _flexM.SetCol("AM_PRE", "종료일", 100, false, typeof(decimal), FormatTpType.YEAR_MONTH_DAY);
            _flexM.SetCol("CORPNO", "분할횟수", 100, false);
            _flexM.SetCol("CORPNO", "특이사항", 100, false);
            _flexM.SetCol("CORPNO", "비고", 100, false);
